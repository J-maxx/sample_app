...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        ...
        Factory(:user, :email => "another@email.org")
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "Joe Schmoe",:email => "user@example.com",
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "New Name",:email => "new.name@user.org",:password => "password",
